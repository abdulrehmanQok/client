...
const Landingpage = () => {
  return (
<section className="text-gray-600 bg-[#FFDBB5]">
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      ...
      <div className="flex w-full md:justify-start justify-center items-end">
        ...
        <button className="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg hidden lg:inline-block">Button</button>
      </div>
    ...
    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
      <img className="object-cover object-center rounded" alt="hero" src="/image/landing.webp" />
    </div>
  </div>
</section>
